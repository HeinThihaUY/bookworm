<?php
    ...
    $id = $_GET['id'];
    $sql = "SELECT order_details.*, books.title, books.author, books.cover, books.price FROM order_details LEFT JOIN books ON order_details.book_id = books.id WHERE order_details.order_id = $id";
